...
import com.mathkruger.marlisoundboard.commands.LouvarMarliCommand;
...
public class LoadPlayerCommands {
    ...
    public static void ILoadPlayerCommands() {
        try {
            ...
            CommandHandler.addCommand(
                    new LouvarMarliCommand("cmd_louvarMarli", Emulator.getTexts().getValue("cmd_louvarMarli.keys").split(";")));
        } catch (Exception ex) {
